...
import pygame
from path_search import a_star as a_path_search, dfs as dfs_path_search
...
#calculates the next coordinate for the snake to move to.
#If the length of the snake is half than the total number of cells, it uses astar. otherwise, it uses DFS to make it computationally less expensive.
...
def main():
    ...
    box_world.init("Cyber python: Optimised", 15, 13)
    box_world.draw_grid()
    box_world.update()
