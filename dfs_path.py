from path_search.dfs import cal
import box_world as box_world
import pygame

if __name__ == "__main__":
    box_world.init("Research HD: DFS path finding")
    ...
    while True:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                box_world.draw_cell_line(path, box_world.COLOR.DARK_GRAY.value, box_world.COLOR.DARK_GREEN.value)
                box_world.draw_cell(end, box_world.COLOR.RED.value)
                box_world.update()
